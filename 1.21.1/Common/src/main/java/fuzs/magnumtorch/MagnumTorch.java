...
public class MagnumTorch implements ModConstructor {
    ...
    private static void registerEventHandlers() {
        ServerEntityLevelEvents.SPAWN.register((Entity entity, ServerLevel serverLevel, @Nullable MobSpawnType mobSpawnType) -> {
            return MobSpawningHandler.onEntityLoad(entity, serverLevel, true);
        });
